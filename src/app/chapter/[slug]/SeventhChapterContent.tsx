      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        {paragraphs.map((t, i) => (
          <div key={i}>
            ...
            {i < paragraphs.length - 1 && <div className="mb-8"><NeonDivider accent={palette.accent} primary={palette.primary} /></div>}
          </div>
        ))}
      </div>
    </section>
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="aspect-video rounded-lg flex items-center justify-center border overflow-hidden relative" style={{ backgroundColor: `${palette.muted}40`, borderColor: `${palette.foreground}10` }}>
          ...
          <div className="text-center relative z-10">
            <MapPin size={32} className="mx-auto mb-3 opacity-60" style={{ color: "#00f5d4" }} />
