      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        {paragraphs.map((t, i) => (
          <div key={i}>
            ...
            {i < paragraphs.length - 1 && <div className="mb-8"><PaisleyDivider accent={palette.accent} /></div>}
          </div>
        ))}
      </div>
    </section>
    ...
    <div className="min-h-screen" style={{ backgroundColor: palette.background, color: palette.foreground }}>
      ...
      <footer className="relative" style={{ backgroundColor: palette.background, borderTop: `1px solid ${palette.accent}12` }}>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 text-center">
          ...
          <p className="text-[11px] font-body tracking-wide" style={{ color: `${palette.foreground}35` }}>April 19–21, 2026 · Udaipur, Rajasthan</p>
        </div>
      </footer>
    </div>
  );
